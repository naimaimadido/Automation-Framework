...
public class BasicIT extends DriverBase {
    ...
    @Test
    public void googleCucumberExample() {
        googleExampleThatSearchesFor("Cucumber!");
    }
    ...
    @Test
    public void googleMeExample() {
        googleExampleThatSearchesFor("Me!");
    }

    @Test
    public void googleYouExample() {
        googleExampleThatSearchesFor("You!");
    }
}